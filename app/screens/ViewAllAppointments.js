      ...
      <SafeAreaView style={styles.container}>
        <SectionList
          sections={[
            ...
            {title: 'Past Appointments', data: customData.sort(function compare(a, b) { var dateA = new Date(a.date); var dateB = new Date(b.date); return dateB-dateA;}).filter((items) => {return new Date(items.date) < new Date()})},
          ...
          renderSectionHeader={({section: {title}}) => <View style={styles.sectionHeader}><Text style={styles.sectionHeader}>{title}</Text></View>}
